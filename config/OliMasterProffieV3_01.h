// Based on https://github.com/BlackDragonN001/SaberFonts
...
// Basic Fonts: 6 by Kyberphonic
	{ "001_BLUE;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "blue"},
/*
	{ "002_GREEN;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "green"},

	{ "003_PURPLE;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "purple"},

	{ "004_RED;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "red"},

	{ "005_WHITE;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "white"},

	{ "006_YELLOW;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "yellow"},
...
// Custom Free Fonts: 33
	...
	{ "007_Battle;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "battle1"},

	// Battlefield v2 by Kyberfonic
	{ "008_Battle2;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "battle2"},

	// Analog by Grayscale
	{ "009_Analog;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "analog"},

	// Apocolypse by Grayscale
	{ "010_Apocalypse;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "apocalypse"},

	// Assassin by Grayscale
	{ "011_Assassin;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "assassin"},

	// Coda by Grayscale
	{ "012_Coda;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "coda"},

	// Crispity by Grayscale
	{ "013_Crispity;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "crispity"},

	// Deadlink by Grayscale
	{ "014_Deadlink;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "deadlink"},

	// Decay by Grayscale
	{ "015_Decay;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "decay"},

	// Endure by Grayscale
	{ "016_Endure;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "endure"},

	// EngineGrip by Grayscale
	{ "017_EngineGrip;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "enginegrip"},

	// Exhalted by Grayscale
	{ "018_Exalted;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "exalted"},

	// Grey by Grayscale
	{ "019_Grey;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "Grey"},

	// Magnetic by Grayscale
	{ "020_Magnetic;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "magnetic"},

	// Masterless by Grayscale
	{ "021_Masterless;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "masterless"},
	...
	// Noble by Grayscale
	{ "023_Noble;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "noble"},

	// Ra by Grayscale
	{ "024_Ra;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "ra"},

	// Seethe by Grayscale
	{ "025_Seethe;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "seethe"},

	// Splinter by Grayscale
	{ "026_Splinter;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "splinter"},

	// Volatile by Grayscale
	{ "027_Volatile;common", "tracks/track1.wav",
	 StylePtr < MasterStyle>(),
	 "volatile"},

	// Age Of Ultron by Harry Solo
	{ "028_PeaceInOurTime;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "peaceinourtime"},

	// Metropolis by Jasper Aykroyd (The Bacon Wizard)
	{ "029_Metropolis;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "metropolis"},

	// Arcane by TehMothman
	{ "030_Arcane;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "arcane"},

	// Nameless by TehMothman
	{ "031_Nameless;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "nameless"},

	// "Rey Skywalker" Smoothswing Font by Daryl John Donato
	{ "032_Rey;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "rey"},

	// Senate Majority v2 by ???
	{ "033_SenateMajority;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "senatemajority"},

	// The Return by ???
	{ "034_TheReturn;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "thereturn"},

	// The Maw by Brian Conner
	{ "035_TheMaw;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "themaw"},

	// Slave1 2.1 by Brian Conner
	{ "036_Slave;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "slave"},

	// Decimate by Jay Dalorian
	{ "037_Decimate;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "decimate"},

	// Knighthood by Fourze
	{ "038_Knighthood;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "knighthood"},

	// Corvus_Tano by Ninja Jedi Order
	{ "039_Corvus_Tano;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "corvustano"},
...
// Free Goofy Fonts
	...
	{ "101_PartyFoul;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "partyfoul"},

	// Lightsaber of the Bells by Jérôme Tremblay ( Jay DaloRian) 
	{ "102_Lightsaber_Of_The_Bells;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "lightsaberofthebells"},

	// Lumos by KidsTryThisAtHome / naitsirkc
	{ "103_Lumos;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "lumos"},

	// Thanos by UltraInstinctKermit
	{ "104_Thanos;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "thanos"},

	// The Predator by Josh Pearl
	{ "105_ThePredator;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "thepredator"},

	// Wild Child by ???
	{ "106_WildChild;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "wildchild"},

	// Witch King by ???
	{ "107_WitchKing;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "witchking"},

	// Energy Sword by XTwistyBoi
	{ "108_EnergySword;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "energysword"},

	// Rave by Brian Conner
	{ "109_Rave;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "rave"},

	// Batman by Meaty Smurf
	{ "110_Batman;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "batman"},

	// JarJar by Darth Hater
	{ "111_JarJar;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "jarjar"},

	// C-137 by Harry Solo Fonts and Synplicity
	{ "112_C-137;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "c-136"},

	// N1_Mod by kyberphonic
	{ "113_N1_Mod;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "n1_mod"},

	// ElectricMouse by kyberphonic
	{ "114_ElectricMouse;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "electricmouse"},

	// Sailor Moon by kyberphonic
	{ "115_SailorMoon;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "sailormoon"},

	// JurassicPark by ???
	{ "116_JurassicPark;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "jurassicpark"},

	// Alien by Blue Force Sabers
	{ "117_Alien;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "alien"},

	// Godzilla by ???
	{ "118_Godzilla;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "godzilla"},

	// Sebulba by 
	{ "119_Sebulba;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "sebulba"},

	// Silent Hill by me
	{ "120_SilentHill;common", "tracks/track1.wav",
	 StylePtr <MasterStyle>(),
	 "silenthill"},
...
*/
	...
	{ "Mother;common", "tracks/track1.wav",
		StylePtr<
			IgnitionDelayX<
				Scale<
					IsLessThan<
...
// Nightsister blade style.
//{ "Mother;common", "tracks/track1.wav", //{ "Fire Talzin;common", "tracks/mars.wav",
