/* ProffieOS_7.14: Control software for lightsabers and other props.
 http://fredrik.hubbe.net/lightsaber/teensy_saber.html
 Copyright (c) 2016-2024 Fredrik Hubinette
 Additional copyright holders listed inline below.*/

#define CONFIG_FILE "config/olicomplex1.5.010.1.h"
// #define CONFIG_FILE "config/OliMasterProffieV3_01.h"  // Not Working
// #define CONFIG_FILE "config/OliTest_QuigonStaff.h"    // Not Working
