// attempt 034 (working version for saber-blaster-detonator-jetpack, all with sound-effects on transition between props.
...
You can find all 5 sound files (created by NoSloppy) used in multi_prop.h in my dropbox here:
...
//#include "../props/blaster_BC_buttons.h"      //use BlasterBC            | Compiling with multi_prop.h (after modifications) (must include "bullet count" in CONFIG_BOTTOM)
