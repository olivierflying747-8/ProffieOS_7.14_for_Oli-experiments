...
==========================================
Power On / Off            - Hold MODE until Power On / Off (Default is auto-power ON)
...
// void BlasterBC() {                              // BC What is this from (latest addition.) ?? I don't think it belongs
//     SaberBase::DoEffect(EFFECT_PLION, 0);
//     SaberBase::SetLockup(SaberBase::LOCKUP_NORMAL);
//     SaberBase::SetPreset(SaberBase::PRESET_LOCKUP);
//     SaberBase::SetMuted(true);
//     SaberBase::SetLockup(SaberBase::LOCKUP_NONE);
//     SaberBase::SetPreset(SaberBase::PRESET_OFF);
//     SaberBase::SetMuted(false);
//   }
...
virtual void Fire() {
  ...
  } else if (blaster_mode == MODE_AUTO) {
...
// Power On / Off manually
    ...
    case EVENTID(BUTTON_MODE_SELECT, EVENT_FIRST_HELD_LONG, MODE_OFF):
